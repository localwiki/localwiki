...
public class HTMLDifferTest {
	...
	public void simpleTextAdd() throws Exception {
		...
		assertTrue("Expected an addition", result
				.indexOf("<p> This is a <span class=\"diff-html-added\"") > -1);
	}
	...
	public void simpleTextRemove() throws Exception {
		...
		assertTrue(
				"Expected an removal",
				result
						.indexOf("<p> This is a <span class=\"diff-html-removed\"") > -1);
	}
	...
	public void simpleTextChange() throws Exception {
		...
		assertTrue(
				...
				result
						.indexOf("<p> This is a <span class=\"diff-html-removed\"") > -1);
		assertTrue("Expected an addition", result
				.indexOf("blue </span><span class=\"diff-html-added\"") > -1);
	}
	...
	public void simpleAttributeAdd() throws Exception {
		...
		assertTrue(
				"Expected a change",
				result
						.indexOf("<p id=\"sample\"><span class=\"diff-html-changed\"") > -1);
	}
	...
	public void simpleTagAdd() throws Exception {
		...
		assertTrue(
				"Expected a change",
				result
						.indexOf("<p> This is a <b><span class=\"diff-html-changed\"") > -1);
	}
	...
	public void twiceChangeText() throws Exception {
		...
		assertTrue(
				...
				result
						.indexOf("<p> This is a <span class=\"diff-html-removed\"") > -1);
		assertTrue("Expected an addition", result
				.indexOf("<span class=\"diff-html-added\"") > -1);
	}
}
