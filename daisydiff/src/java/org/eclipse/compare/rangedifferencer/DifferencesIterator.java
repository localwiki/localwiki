...
/**
 * A custom iterator to iterate over a List of <code>RangeDifferences</code>. It
 * is used internally by the <code>RangeDifferencer</code>.
 */
/* package */class DifferencesIterator {
	...
	/*
	 * Creates a differences iterator on an array of
	 * <code>RangeDifference</code>s.
	 */
	...
	/*
	 * Appends the edit to its list and moves to the next
	 * <code>RangeDifference</code>.
	 */
	void next() {
