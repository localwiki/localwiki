 ...
 * returned from the <code>RangeDifferencer</code> <code>find* </code> methods.
 * Clients use these objects as they are returned from the differencer. This
 * class is not intended to be instantiated or subclassed outside of the Compare
 * framework.
 * <p>
 * Note: A range in the <code>RangeDifference</code> object is given as a start
 * index and length in terms of comparable entities. However, these entity
