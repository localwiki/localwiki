...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('redirects_redirect', (
            ...
            ('source', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255)),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pages.Page'])),
        ))
        db.send_create_signal('redirects', ['Redirect'])

        # Adding model 'Redirect_hist'
        db.create_table('redirects_redirect_hist', (
            ('id', self.gf('django.db.models.fields.IntegerField')(db_index=True, blank=True)),
            ('source', self.gf('django.db.models.fields.SlugField')(max_length=255)),
            ...
            ('history_reverted_to_version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['redirects.Redirect_hist'], null=True)),
            ...
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pages.Page_hist'])),
        ))
        db.send_create_signal('redirects', ['Redirect_hist'])

    def backwards(self, orm):
        # Deleting model 'Redirect'
        db.delete_table('redirects_redirect')

        # Deleting model 'Redirect_hist'
        db.delete_table('redirects_redirect_hist')
