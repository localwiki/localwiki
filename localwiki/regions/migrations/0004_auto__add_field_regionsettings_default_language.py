...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegionSettings.default_language'
        db.add_column(u'regions_regionsettings', 'default_language',
                      self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegionSettings.default_language'
        db.delete_column(u'regions_regionsettings', 'default_language')
