...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegionSettings.domain'
        db.add_column(u'regions_regionsettings', 'domain',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegionSettings.domain'
        db.delete_column(u'regions_regionsettings', 'domain')
