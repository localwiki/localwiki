...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegionSettings.logo'
        db.add_column(u'regions_regionsettings', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegionSettings.logo'
        db.delete_column(u'regions_regionsettings', 'logo')
