...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field admins on 'RegionSettings'
        m2m_table_name = db.shorten_name(u'regions_regionsettings_admins')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('regionsettings', models.ForeignKey(orm[u'regions.regionsettings'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['regionsettings_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field admins on 'RegionSettings'
        db.delete_table(db.shorten_name(u'regions_regionsettings_admins'))
