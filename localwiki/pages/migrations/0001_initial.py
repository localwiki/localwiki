...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pages_page', (
            ...
            ('content', self.gf('pages.fields.WikiHTMLField')()),
        ))
        db.send_create_signal('pages', ['Page'])

        # Adding model 'Page_hist'
        db.create_table('pages_page_hist', (
            ...
            ('history_reverted_to_version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pages.Page_hist'], null=True)),
        ...
        db.send_create_signal('pages', ['Page_hist'])

        # Adding model 'PageFile'
        db.create_table('pages_pagefile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255)),
        ))
        db.send_create_signal('pages', ['PageFile'])

        # Adding unique constraint on 'PageFile', fields ['slug', 'name']
        db.create_unique('pages_pagefile', ['slug', 'name'])

        # Adding model 'PageFile_hist'
        db.create_table('pages_pagefile_hist', (
            ('id', self.gf('django.db.models.fields.IntegerField')(db_index=True, blank=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255)),
            ...
            ('history_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('history_type', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('history_reverted_to_version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pages.PageFile_hist'], null=True)),
            ('history_comment', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('history_user', self.gf('versionutils.versioning.fields.AutoUserField')(to=orm['auth.User'], null=True)),
            ('history_user_ip', self.gf('versionutils.versioning.fields.AutoIPAddressField')(max_length=15, null=True)),
        ))
        db.send_create_signal('pages', ['PageFile_hist'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Page_hist'
        db.delete_table('pages_page_hist')

        # Deleting model 'PageFile'
        db.delete_table('pages_pagefile')

        # Deleting model 'PageFile_hist'
        db.delete_table('pages_pagefile_hist')
