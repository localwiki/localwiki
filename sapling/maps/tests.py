...
class FlatGeometryCollectionTest(TestCase):
    def test_flatten(self):
        ...
        self.assertTrue(field._flatten(geom).equals(expected_geom) or
                        field._flatten(geom).equals_exact(expected_geom, 0.001))
        ...
        self.assertTrue(field._flatten(geom).equals(geom) or
                        field._flatten(geom).equals_exact(geom, 0.001))
