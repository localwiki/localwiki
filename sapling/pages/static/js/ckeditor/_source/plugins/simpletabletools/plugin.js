...
(function()
{
	...
	CKEDITOR.plugins.tabletools =
	{
		init : function( editor )
		{
			...
			editor.addCommand( 'simpleCellProperties', new CKEDITOR.dialogCommand( 'simpleCellProperties' ) );
			CKEDITOR.dialog.add( 'simpleCellProperties', this.path + 'dialogs/simpletablecell.js' );
	...
	CKEDITOR.plugins.add( 'simpletabletools', CKEDITOR.plugins.tabletools );
})();
